...
class ApiExceptionTest extends TestCase {
    ...
    public function testMessage() {
        ...
        $this->expectExceptionMessage('this is the error message.');

        $this->mockResponse( new Response(
            400, [ 'Content-Type' => 'application/json; charset=utf-8' ],
            Psr7\Utils::streamFor( '{"text":"this is the error message."}' )
        ));
    ...
    public function testUnknownException() {
        $this->expectException(\GW2Treasures\GW2Api\Exception\ApiException::class);
        $this->expectExceptionMessage('Unknown GW2Api error');
        $this->mockResponse( new Response(
            500, [], Psr7\Utils::streamFor( 'Internal server error' )
        ));
    ...
    public function testRequestExceptionWithoutResponse() {
        ...
        $this->expectExceptionMessage('RequestExceptionWithoutResponse');
    ...
    public function testRequestManyExceptionWithoutResponse() {
        $this->expectException(\GuzzleHttp\Exception\ConnectException::class);
        $this->expectExceptionMessage('RequestManyExceptionWithoutResponse');
